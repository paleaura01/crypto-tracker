...
{#if hydrated}
  <div class="max-w-md mx-auto mt-16 p-6 bg-gray-50 text-gray-800 dark:bg-gray-700 rounded shadow-lg">
    ...
    <form on:submit|preventDefault={handleLogin} class="space-y-4">
      ...
      <input
        ...
        required
        class="w-full px-4 py-2 border rounded border-gray-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
      />
